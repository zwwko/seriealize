//2. Encode the data using JSON schema and embed the schema as metadata along with the data. On the other end, just decode the data using the embedded schema.
package avro;
